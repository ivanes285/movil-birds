...
class CheckInternetConnection {
  ...
  Stream<ConnectionStatus> internetStatus() {
    // esta suscribcion me permite cada vez que se conecte o desconecte de internet ejecutar la funcion _checkInternetConnection
  ...
  Future<void> _checkInternetConnection() async {
    try {
      await Future.delayed(const Duration(
          seconds:
              3)); //con esto le permito al cel que se tome tiempo a conectarse al wifi
